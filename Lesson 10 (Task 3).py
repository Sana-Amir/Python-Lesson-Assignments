...
class TVController:
    ...
    def turn_channel(self, channel):
        # channel can be from 1 to a no. of channels
        # to return 1st channel from the list of channels, index should be 0 (1-1)
        # for channel 1(2-1)(like maths)
...
#controller.first_channel(1) == "BBC"
print("Channel under no. 1: ", controller.turn_channel(1))
...
print("Have channel no. 4: ", controller.is_exist(4))
